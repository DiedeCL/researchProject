  ...
  <div class="assignments">
    <div class="sortAndFilterOptions">
      ...
      <select id="selectFilterStatus" v-model="selectedFilterStatus">
        ...
        <option value="Opdracht verzonden">Ongelezen</option>
      ...
      <select id="selectFilterStatusLector" v-model="selectedFilterStatusLector">
        ...
        <option value="Verschillende reviews">Verschillende reviews</option>
        <option value="Afgekeurd">Afgekeurd</option>
        <option value="Behandeling">In behandeling</option>
        <option value="Goedgekeurd">Goedgekeurd</option>
      </select>
...
<script>
  ...
  export default {
    ...
    mounted() {
      fetch("https://localhost:5001/api/assignments/InternshipAssignments", this.requestOptions).then(response =>
    ...
    computed : {
      computed_items: function () {
        ...
        if(filterSpecialization === "Afstudeerrichting" && search === ""  && filterStatus === "Status" && filterEnvironment === "Omgeving" && searchOnCompany === "" && filterStatusLector === "Lector Status"){

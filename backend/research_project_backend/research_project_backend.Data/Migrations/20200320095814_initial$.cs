        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraDescriptionEnvironments = table.Column<string>(nullable: true),
                    Conditions = table.Column<string>(nullable: true),
                    ResearchTheme = table.Column<string>(nullable: true),
                    LocationAddressId = table.Column<int>(nullable: true),
                    AmountOfSupportingEmployees = table.Column<int>(nullable: false),
                    AmountOfInterns = table.Column<int>(nullable: false),
                    SpecificStudentFirstAndLastName = table.Column<string>(nullable: true),
                    OtherComments = table.Column<string>(nullable: true),
                    InternshipPeriod = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_Address_LocationAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressCompanyAddressId = table.Column<int>(nullable: true),
                    AmountOfPersonnel = table.Column<int>(nullable: false),
                    AmountOfITPersonnel = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.AddressCompanyAddressId,
                        principalTable: "Address",
                        principalColumn: "AddressId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternshipAssignmentId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IntroductionCondition", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactCompany_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "CompanyId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_LocationAddressId",
                table: "Assignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IntroductionCondition_InternshipAssignmentId",
